...
type ClaudeKey struct {
	...
	// ExperimentalCCHSigning is deprecated and retained only for configuration
	// compatibility. CCH follows Claude Code's first-party host and calibrated
	// version gate automatically.
